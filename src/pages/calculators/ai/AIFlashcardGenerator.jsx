...
import { generateFlashcards } from '../../../services/groqAI'
...
function AIFlashcardGenerator() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const quiz = await generateFlashcards(subject, difficulty)
            setResult(quiz)
    ...
    return (
        <CalculatorLayout
            ...
            description="Create 10 study flashcards for any subject or concept"
            category="AI Tools"
        ...
        >
            <div className="input-group">
                ...
                <textarea
                    ...
                    placeholder="e.g., Human Anatomy, European History 1800-1900, Python programming basics..."
                    rows={3}
                    style={{
                        width: '100%',
                        padding: '12px',
            ...
            <button
                ...
                style={{
                    width: '100%',
                    padding: '16px',
                    background: loading || !subject.trim() ? '#333' : 'linear-gradient(135deg, #a78bfa 0%, #8b5cf6 100%)',
                    border: 'none',
                    borderRadius: '12px',
                    color: 'white',
